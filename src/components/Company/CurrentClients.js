...
const CurrentClients = () => {
  ...
  const getActiveCompanies = () => {
    return companyData.filter((comp) => getStatus(comp.sdate, comp.edate) === 'Active');
  };
  ...
  return (
    <div className='company-second'>
        <div>
            <h2 className='text-[22px] text-[#BC7FCD] mt-2'>Current Clients</h2>
            ...
            {getActiveCompanies().length > 0 ? (
              getActiveCompanies().map((comp, index) => (
                ...
                <div className="mobile-row">
                  <p colSpan="9" className='no-client-p'>
